...
public class KThread {
	...
	public static void finish() {
		...
		while (currentThread.join_queue.size() != 0) {
			KThread popped = currentThread.join_queue.poll();
			popped.ready();
		}
	...
	public void join() {
		...
		if (is_joined || status == statusFinished) {
			return;
		}

		join_queue.addLast(currentThread);
		currentThread.sleep();
		is_joined = true;
	...
	private LinkedList<KThread> join_queue = new LinkedList<KThread>();
